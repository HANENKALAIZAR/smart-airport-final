                ...
                {prediction && (
                    <div className="card">
                        ...
                        {prediction.explanation_text ? (
                            <div style={{ marginBottom: 'var(--space-lg)', padding: '12px 14px', borderRadius: 'var(--radius-md)', background: 'rgba(14,165,233,0.07)', border: '1px solid rgba(14,165,233,0.2)' }}>
                                <div style={{ fontSize: '0.72rem', fontWeight: 700, color: 'var(--primary-400)', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 6 }}>
                                    🤖 Why does the AI predict this?
                                </div>
                            ...
                            <div style={{ marginBottom: 'var(--space-lg)', padding: '10px 14px', borderRadius: 'var(--radius-md)', background: 'rgba(0,0,0,0.04)', border: '1px solid rgba(0,0,0,0.08)' }}>
                                <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', margin: 0, fontStyle: 'italic' }}>
                                    AI explanation is not available for this prediction.
                                </p>
                            </div>
                        )}
