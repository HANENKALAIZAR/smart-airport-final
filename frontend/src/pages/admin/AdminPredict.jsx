                ...
                {result && (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                        ...
                        <div className="admin-card" style={{ padding: '1rem 1.25rem' }}>
                            <div style={{ fontSize: '0.72rem', color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', letterSpacing: '0.07em', marginBottom: 8 }}>
                                🤖 Why does the AI predict this?
                            </div>
                            {result.explanation_text ? (
                                <p style={{ fontSize: '0.83rem', color: 'rgba(255,255,255,0.82)', lineHeight: 1.55, margin: 0 }}>
                                    {result.explanation_text}
                                </p>
                            ) : (
                                <p style={{ fontSize: '0.82rem', color: 'rgba(255,255,255,0.3)', fontStyle: 'italic', margin: 0 }}>
